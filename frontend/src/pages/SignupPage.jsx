      ...
      <div className="max-w-4xl w-full mx-auto grid md:grid-cols-2 gap-10 items-center">
        <div className="hidden md:flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h2 className="font-display text-2xl font-semibold">A soft place for loud thoughts</h2>
            <p className="text-muted-foreground mt-2">
              Write, keep and revisit your notes. Everything you write stays yours alone.
            </p>
          </div>
        </div>
        ...
        <div className="paper-card p-8">
          ...
          <p className="text-muted-foreground mt-1 mb-6">Takes about a minute.</p>
